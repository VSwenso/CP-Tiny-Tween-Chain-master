class Basics extends Phaser.Scene {
    ...
    create() {
            ...
            tweens: [
                {
                    ...
                    ease: 'Bounce.easeOut',
                    onComplete: () => {
                        verygoodpear.angle += 90; //rotate the pear by 90
                    },
                },
                {
                    y: h - 64,
                    ...
                    ease: 'Sine.easeOut', 
                    onComplete: () => {
                        verygoodpear.angle += 90; //Rotate by 90
                    },
                },
                {
                    x : 64,
        ...
        //Bonus: make it so the pear rotates 90deg each time it hits a corner. 
        //plus if you re-click it it goes back to the starting position. 
